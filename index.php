            ...
            <div class="row justify-content-center mt40">
                <div class="col-sm-6 rounded-4 border p25 px60">
                    ...
                    <div class="text-center mx-auto w-75 d-grid gap-6">
                        <a href="<?= base_url('improve.php')?>" class="btn btn-primary bg-primary-2 rounded-pill py10 fs15 my15">Create a new wallet</a>
                        <a href="<?= base_url('improve.php')?>" class="btn btn-outline-primary rounded-pill py10 fs15 my15">Import an existing wallet</a>
                    </div>
                </div>
            </div>
        </div>
